...
if ($USE_ALL.IsPresent) {
    $FRAMEWORKS = @('net48', 'netcoreapp3.1', 'net5.0', 'net6.0', 'net7.0', 'net8.0', 'net9.0', 'net10.0') # TODO: Support all frameworks
}
        ...
        foreach ($RUNTIME in $RUNTIMES) {
            ...
            if ($INCLUDE_DEBUG.IsPresent) {
                ...
                if ($BUILD_VERSION -ne $null) {
                    7z a -tzip $BUILD_FOLDER\Headerer_${BUILD_VERSION}_${FRAMEWORK}_${RUNTIME}_debug.zip *
                }
                else {
            ...
            if ($BUILD_VERSION -ne $null) {
                7z a -tzip $BUILD_FOLDER\Headerer_${BUILD_VERSION}_${FRAMEWORK}_${RUNTIME}_release.zip *
            }
            else {
