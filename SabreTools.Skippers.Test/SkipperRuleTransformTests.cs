...
namespace SabreTools.Skippers.Test
{
    ...
    public class RuleTransformTests
    {
        ...
        [InlineData(new byte[] { 0x50, 0x53, 0x49, 0x44, 0x00, 0x02, 0x00, 0x76 }, 0x76)]
        [InlineData(new byte[] { 0x50, 0x53, 0x49, 0x44, 0x00, 0x03, 0x00, 0x76 }, 0x76)]
        [InlineData(new byte[] { 0x50, 0x53, 0x49, 0x44, 0x00, 0x04, 0x00, 0x76 }, 0x76)]
        ...
        [InlineData(new byte[] { 0x50, 0x53, 0x49, 0x44, 0x00, 0x03, 0x00, 0x7c }, 0x7c)]
        [InlineData(new byte[] { 0x50, 0x53, 0x49, 0x44, 0x00, 0x04, 0x00, 0x7c }, 0x7c)]
        [InlineData(new byte[] { 0x52, 0x53, 0x49, 0x44, 0x00, 0x01, 0x00, 0x76 }, 0x76)]
        [InlineData(new byte[] { 0x52, 0x53, 0x49, 0x44, 0x00, 0x02, 0x00, 0x76 }, 0x76)]
        [InlineData(new byte[] { 0x52, 0x53, 0x49, 0x44, 0x00, 0x03, 0x00, 0x76 }, 0x76)]
        [InlineData(new byte[] { 0x52, 0x53, 0x49, 0x44, 0x00, 0x04, 0x00, 0x76 }, 0x76)]
        [InlineData(new byte[] { 0x52, 0x53, 0x49, 0x44, 0x00, 0x01, 0x00, 0x7c }, 0x7c)]
        [InlineData(new byte[] { 0x52, 0x53, 0x49, 0x44, 0x00, 0x02, 0x00, 0x7c }, 0x7c)]
        [InlineData(new byte[] { 0x52, 0x53, 0x49, 0x44, 0x00, 0x03, 0x00, 0x7c }, 0x7c)]
        [InlineData(new byte[] { 0x52, 0x53, 0x49, 0x44, 0x00, 0x04, 0x00, 0x7c }, 0x7c)]
